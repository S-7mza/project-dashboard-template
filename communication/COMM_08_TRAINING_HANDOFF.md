...
- **T–7 to T–5 days:** Announcement of training sessions and registration.
- **T–3 to T–2 days:** Detailed agenda + pre-work (e.g., accounts, access, data). 
- **T–0 morning:** Reminder for training session(s).
- **T+0 / T+1 days:** Thank you + materials + quick-start guides.
- **T+5 days:** Adoption check-in + survey / feedback.

---

## 4. Pre-Workshop Email – Announce Training (T–7 to T–5)
...
**Audience:** End-users and key users

Please register for one of the available slots using &lt;registration link / invite&gt;.

Best regards,  
Training Lead


## 5. Pre-Workshop Email – Agenda & Pre-work (T–3 to T–2)
...
**Audience:** End-users, key users, Product Owner, support
...
Please join a few minutes early to verify your access and audio.

See you soon,  
Training Lead


## 7. Post-Workshop Email – Materials & Support (T+0 / T+1)
